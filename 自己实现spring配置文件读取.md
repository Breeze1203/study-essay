...
<beans>
    <bean id="demo" class="com.spring.entity.demo"></bean>
    <bean id="date" class="java.util.Date"></bean>
    <bean id="text" class="com.spring.entity.Text"></bean>
</beans>
```
...
public class demo {
    public static void main(String[] args) {
        ApplicationContext c=new ApplicationContext("context.xml");
        Text text= (Text) c.getBean("text");
